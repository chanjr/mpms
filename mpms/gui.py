...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def open_dat_file(self, *args, **kwargs):
        filenames, filetype = QtWidgets.QFileDialog.getOpenFileNames(filter = "MPMS data files (*.dat)")
    ...
    def open_raw_file(self, *args, **kwargs):
        filenames, filetype = QtWidgets.QFileDialog.getOpenFileNames(filter = "MPMS raw files (*.raw)")
        data = [cached_load(fname[:-4]) for fname in filenames]
